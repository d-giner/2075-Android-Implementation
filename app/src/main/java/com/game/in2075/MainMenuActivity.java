...
public class MainMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startGameBttn = findViewById(R.id.startGameButton);

        startGameBttn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (getApplicationContext(), UnityPlayerActivity.class); /** Go to Main Nav. Menu Activy if login success*/
    ...
    // Tactil control between activities
